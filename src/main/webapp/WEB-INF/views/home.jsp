...
<div class="container marketing">
    ...
    <div class="row">
        <div class="col-lg-4">
            <a class="btn btn-default" href="<c:url value="/product/productList?searchCondition=Pizza" />"
               role="button">
                <img class="img-circle" src="<c:url value="/resources/images/instrument.jpg" />" alt="Pizza
    ...
    <div class="row">
        <div class="col-lg-4">
            <a class="btn btn-default" href="<c:url value="/product/productList?searchCondition=Burger" />"
               role="button">
                <img class="img-circle" src="<c:url value="/resources/images/record.jpg" />" alt="Burger
                Image" width="140" height="140"></a>
    ...
    <div class="row">
        <div class="col-lg-4">
            <a class="btn btn-default" href="<c:url value="/product/productList?searchCondition=Sandwich" />"
               role="button">
                <img class="img-circle" src="<c:url value="/resources/images/accessory.jpg" />" alt="Sandwich
                Image" width="140" height="140"></a>
